...
private fun <T> SharedPreferences.liveData(
    ...
    key: String,
    defValue: T
): LiveData<T> = SharedPreferenceLiveData(
    this,
    key,
...
private fun <T> SharedPreferences.getDelegate(
    ...
    Int::class.java -> IntPreference(this, key, defValue as Int)
    Long::class.java -> LongPreference(this, key, defValue as Long)
    Float::class.java -> FloatPreference(this, key, defValue as Float)
    Boolean::class.java -> BooleanPreference(this, key, defValue as Boolean)
    String::class.java -> StringPreference(this, key, defValue as String?)
