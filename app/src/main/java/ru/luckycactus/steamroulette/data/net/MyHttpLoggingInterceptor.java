...
public final class MyHttpLoggingInterceptor implements Interceptor {
    ...
    public MyHttpLoggingInterceptor(Set<String> notLogBodyPaths) {
        this(MyHttpLoggingInterceptor.Logger.DEFAULT, notLogBodyPaths);
    }
    ...
    public MyHttpLoggingInterceptor(MyHttpLoggingInterceptor.Logger logger, Set<String> notLogBodyPaths) {
        this.logger = logger;
        this.notLogBodyPaths = notLogBodyPaths;
    }

    private final MyHttpLoggingInterceptor.Logger logger;

    private final Set<String> notLogBodyPaths;
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (logBody && notLogBodyPaths != null) {
            String encodedPath = request.url().encodedPath();
            for (String url : notLogBodyPaths) {
                if (encodedPath.contains(url)) {
                    logBody = false;
                    break;
                }
            }
