...
@AndroidEntryPoint
class OldLibraryFragment : BaseFragment(R.layout.fragment_library), MessageDialogFragment.Callbacks {
    ...
    companion object {
        ...
        fun newInstance(onlyHidden: Boolean = false) = OldLibraryFragment().apply {
